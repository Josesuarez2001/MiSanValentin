...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').style.overflow = 'auto';
    document.getElementById('messageContainer').innerHTML = 'Sabia que Aceptarias, Te Amo mucho, \n Ahora eres mi San Valentin ❤️ te dare muchos besitos';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').style.backgroundColor = 'crimson';
